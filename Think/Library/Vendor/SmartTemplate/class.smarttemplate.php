<?php
	...
	* Usage Example I:
	*
	* $page = new SmartTemplate( "templates.html" );
	...
	*/
	class SmartTemplate
	{
		...
		*/
		...
		/**
		* The compiled templates filename
		*
		* @access private
		*/
		var $cpl_file;
		...
		*/
		function output ( $_top = '' )
		{
			...
			//	Check if templates is already compiled
			...
			{
				exit( "SmartTemplate Error: You must set a templates file name");
			}
