...
class Template_Lite {
	...
	var $left_delimiter			= "{";		// the left delimiter for templates tags
	var $right_delimiter			= "}";		// the right delimiter for templates tags
	...
	var $php_extract_vars		=	false;	// Set this to true if you want the $this->_tpl variables to be extracted for use by PHP code inside the templates.
