...
abstract class Smarty_Resource {
     ...
     * @throws SmartyException if default templates handler is registered but not callable
     */
    protected function buildFilepath(Smarty_Template_Source $source, Smarty_Internal_Template $_template=null)
    {
        ...
        if ($_template && $_template->parent instanceof Smarty_Internal_Template && $_file_is_dotted) {
            ...
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $file)) {
                // the path gained from the parent templates is relative to the current working directory
    ...
    public static function source(Smarty_Internal_Template $_template=null, Smarty $smarty=null, $template_resource=null)
    {
        ...
        // check runtime cache
        $_cache_key = 'templates|' . $unique_resource_name;
 ...
 * @property boolean $templates  Extended Template reference
...
class Smarty_Template_Source {
     ...
     *
     * @param Smarty_Internal_Template $_template templates objet
     ...
     *
     * @param string $property_name valid: timestamp, exists, content, templates
