...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase {
    ...
    /**
     * special compiled and cached templates properties
     * @var array
     */
    ...
    public $smarty = null;
    /**
     * blocks for templates inheritance
     * @var array
     */
    ...
    /**
     * internal flag to allow relative path in child templates blocks
     * @var bool
     */
     ...
     * It load the required templates resources and cacher plugins
     *
    ...
    public function __construct($template_resource, $smarty, $_parent = null, $_cache_id = null, $_compile_id = null, $_caching = null, $_cache_lifetime = null)
    {
        ...
        // copy block data of templates inheritance
     ...
     *
     * It does compare the timestamps of templates source and the compiled templates and checks the force compile configuration
     *
     * @return boolean true if the templates must be compiled
     */
    public function mustCompile()
    {
        if (!$this->source->exists) {
            ...
            throw new SmartyException("Unable to load templates {$this->source->type} '{$this->source->name}'{$parent_resource}");
        }
    ...
    public function compileTemplateSource()
    {
        ...
        if (!$this->source->recompiled && $this->compiler->write_compiled_code) {
            ...
            if ($_filepath === false)
                throw new SmartyException('getCompiledFilepath() did not return a destination to save the compiled templates to');
    ...
    /**
     * Writes the cached templates output
     *
     * @return bool
     */
     ...
     * @returns string templates content
     */
    public function getSubTemplate($template, $cache_id, $compile_id, $caching, $cache_lifetime, $data, $parent_scope)
    {
        ...
        if (isset($this->smarty->template_objects[$_templateId])) {
            // clone cached templates object because of possible recursive call
    ...
    /**
     * Template code runtime function to get pointer to templates variable array of requested scope
     *
     * @param int $scope    requested variable scope
     * @return array        array of templates variables
     */
    ...
    /**
     * Get parent or root of templates parent chain
     *
    ...
    /**
    * Empty cache for this templates
    *
    ...
    */
    ...
    public function __set($property_name, $value)
    {
        switch ($property_name) {
            ...
            // FIXME: routing of templates -> smarty attributes
            default:
    ...
    public function __get($property_name)
    {
        switch ($property_name) {
            case 'source':
                ...
                // cache templates object under a unique ID
