...
abstract class Smarty_Internal_TemplateCompilerBase {
    ...
    /**
     * suppress generation of merged templates code
     *
     * @var bool
     */
    ...
    /**
     * suppress Smarty header code in compiled templates
     * @var bool
     */
    public $suppressHeader = false;
    /**
     * suppress templates property header code in compiled templates
     * @var bool
     */
    ...
    /**
     * flag if currently a templates function is compiled
     * @var bool
     */
    public $compiles_template_function = false;
    /**
     * called subfuntions from templates function
     * @var array
     */
    ...
    public function compileTemplate(Smarty_Internal_Template $template)
    {
        ...
        do {
            ...
            // on empty templates just return header
            if ($_content == '') {
        ...
        // return compiled code to templates object
        $merged_code = '';
    ...
    public function trigger_template_error($args = null, $line = null)
    {
        ...
        $match = preg_split("/\n/", $this->lex->data);
        $error_text = 'Syntax Error in templates "' . $this->template->source->filepath . '"  on line ' . $line . ' "' . htmlspecialchars(trim(preg_replace('![\t\r\n]+!',' ',$match[$line-1]))) . '" ';
        if (isset($args)) {
