 ...
 *
 * This file contains the basic shared methodes for templates handling
 *
 * @package Smarty
 * @subpackage Template
 * @author Uwe Tews
...
/**
 * Class with shared templates methodes
 *
 * @package Smarty
 * @subpackage Template
 */
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
     ...
     * @param bool   $merge_tpl_vars    if true parent templates variables merged in to local scope
    ...
    public function fetch($template = null, $cache_id = null, $compile_id = null, $parent = null, $display = false, $merge_tpl_vars = true, $no_output_filter = false)
    {
        ...
        // create templates object if necessary
        ...
        // merge all variable scopes into templates
        if ($merge_tpl_vars) {
        ...
        // must reset merge templates date
        ...
        if (!($_template->caching == Smarty::CACHING_LIFETIME_CURRENT || $_template->caching == Smarty::CACHING_LIFETIME_SAVED) || !$_template->cached->valid) {
            // render templates (not loaded and not in cache)
     ...
     *
     * @param string|object $template   the resource handle of the templates file or templates object
     * @param mixed         $cache_id   cache id to be used with this templates
     * @param mixed         $compile_id compile id to be used with this templates
     * @param object        $parent     next higher level of Smarty variables
     ...
     * @param string   $tag        name of templates tag
    ...
    /**
     * Registers a cache resource to cache a templates's output
     *
     ...
     *
     * @param string $class name of templates class
    ...
    /**
     * Registers a default templates handler
     *
     * @param callable $callback class/method name
     * @throws SmartyException if $callback is not callable
     */
    public function registerDefaultTemplateHandler($callback)
    {
        if (is_callable($callback)) {
            ...
            throw new SmartyException("Default templates handler '$callback' not callable");
        }
    }
